            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 border-b border-gray-200">
                    <div class="flex items-center mb-6">
                        ...
                        <h2 class="text-2xl font-black uppercase tracking-tight">Add New Product</h2>
                    </div>

                    <form action="{{ route('admin.products.store') }}" method="POST" class="max-w-2xl bg-gray-50 p-8 rounded-xl border border-gray-100 shadow-inner">
                        @csrf
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-2">
                                <label for="name" class="block text-sm font-bold text-gray-700 mb-1 uppercase tracking-wider">Product Name</label>
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 transition-all" required>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="description" id="description" rows="4" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 transition-all" required>{{ old('description') }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="price" id="price" value="{{ old('price') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 transition-all font-black" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="stock" id="stock" value="{{ old('stock') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 transition-all" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="image_url" id="image_url" value="{{ old('image_url') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 transition-all" placeholder="https://example.com/image.jpg">
